...
public class PortalCreationUtil {
    ...
    public static boolean attemptCreation (Player player, Block lever) {
        ...
        if(checkPossibleSmallPortal(portal)) {
            ...
            if(gateName.isEmpty()) {
                ...
                PowerPortal powerPortal = PortalStorageUtil.createPowerPortal(player, gateName, origin.getLocation());
    ...
    private static boolean checkDistance(Location origin) {
        for (PowerPortal portal: PortalStorageUtil.getPowerPortals()) {
